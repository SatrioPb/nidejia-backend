...
use Filamen\Support\Enums\FontWeight;
        ...
        return $form
            ->schema([
                Forms\Components\TextInput::make('title')
                    ->required()
                    ->afterStateUpdated(fn(Set $set, ?string $state) => $set('slug', Str::slug($state))) // Corrected syntax
                    ->live(debounce: 750) // Corrected 'debounce' spelling
                    ->maxLength(255),
                Forms\Components\TextInput::make('slug')
                    ->disabled(),
                Forms\Components\Textarea::make('description') // Corrected capitalization
                    ->required()
                    ->maxLength(500),
                ...
                Forms\Components\Checkbox::make('gym_area_available')
                    ->default(0),
                Forms\Components\Checkbox::make('mini_cave_available')
                    ->default(0),
